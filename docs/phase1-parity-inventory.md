...
Checked 2026-09-26 against implementation commit `140e1e12729392f1a52de81c81b43d0dd15d318f` and [green CI run 36224550725](https://github.com/PapaBill1234/hotel-drogon/actions/runs/36224550725). This file tracks the Drogon/React application. The former 50 KB inventory, including the Laravel attempt and the investigation diary, is preserved verbatim in [the v1 archive](archive/phase1-parity-inventory-v1.md) and in Git history. The [stable plan](cpp-drogon-conversion-plan.md) owns architecture and safety rules; [run state](ai-run-state.md) owns the active unit.
...
**Exact next work unit:** complete the Phase 1 OpenAPI first slice for the implemented auth routes, `/api/me`, and existing profile mutations. Read their current controllers and the corresponding PHPRetro behavior, then validate request bodies, responses, cookies, status codes, and failure cases against live isolated routes. Do not describe unimplemented operations as working or start the Phase 5 account frontend before this contract is truthful.
